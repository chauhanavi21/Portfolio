...
// Internship experience section.  Displays a list of internships
// as cards with hover overlays.  Colours mirror the dark theme of
...
const Experience = () => {
  return (
    <section id="experience" className="px-6 py-20 text-center min-h-screen snap-start">
      <h2 className="text-3xl font-bold mb-10 text-white">Internship Experience</h2>
      <div className="flex flex-wrap justify-center gap-6">
        {internships.map((item, index) => (
          <motion.div
            key={index}
            className="relative bg-[#2d2d2d] p-6 rounded-lg shadow-md overflow-hidden group text-left cursor-pointer w-full sm:w-[42%] transition-all hover:shadow-lg border border-gray-700"
          ...
          >
            ...
            <motion.div
              className="absolute inset-0 bg-[#1a1a1a]/95 p-6 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 border border-gray-700"
            >
