...
// Contact section: provides links for email and LinkedIn along
// with a location map and footer navigation.  The design sticks to
// the dark theme with subtle contrast on hover states.
      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-16">
          <a
            ...
            className="flex items-center gap-3 border border-gray-700 px-6 py-4 rounded-xl bg-[#2d2d2d] hover:bg-purple-600 hover:border-purple-600 hover:text-white transition shadow-md"
          >
        ...
        {/* Map */}
        <div className="w-full max-w-4xl mx-auto rounded-lg overflow-hidden shadow-lg border border-gray-700">
          <iframe
